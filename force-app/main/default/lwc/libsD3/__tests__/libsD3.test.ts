...
describe('c-libs-d3', () => {
    ...
    it('loads the D3 javascript and css static resources', () => {
        ...
        expect((<jest.MockInstance<any, any>><unknown>loadScript).mock.calls[0][1]).toEqual(D3_JS);
        expect((<jest.MockInstance<any, any>><unknown>loadStyle).mock.calls[0][1]).toEqual(D3_CSS);
    });
