...
describe('c-lms-subscriber-web-component', () => {
    ...
    it('registers the LMS subscriber during the component lifecycle', () => {
        ...
        expect((<jest.MockInstance<any, any>><unknown>subscribe).mock.calls[0][1]).toBe(RECORD_SELECTED_CHANNEL);
    });
    ...
    describe('getRecord @wire data', () => {
        ...
        it('renders contact details without picture', async () => {
            ...
            // Emit data from @wire
            (<LdsTestWireAdapter><unknown>getRecord).emit(mockGetRecordNoPicture);
