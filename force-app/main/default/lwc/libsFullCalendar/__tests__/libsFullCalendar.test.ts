...
describe('c-libs-full-calendar', () => {
    ...
    it('loads the FullCalendar javascript and css static resources', () => {
        ...
        expect((<jest.MockInstance<any, any>><unknown>loadScript).mock.calls[0][1]).toEqual(FULL_CALENDAR_JS);
        expect((<jest.MockInstance<any, any>><unknown>loadStyle).mock.calls[0][1]).toEqual(FULL_CALENDAR_CSS);
    });
