...
describe('c-misc-content-asset', () => {
    ...
    it('sets img url based on content asset', () => {
        ...
        const imgRecipesEl = element.shadowRoot.querySelector<HTMLImageElement>(
            'img[alt="Recipes logo"]'
        );
        expect(imgRecipesEl).not.toBeNull();
        // sfdx-lwc-jest auto-mocks @salesforce/contentAsset, and returns localhost/name_of_content_asset.
