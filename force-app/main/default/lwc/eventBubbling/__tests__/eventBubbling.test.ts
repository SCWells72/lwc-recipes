// noinspection DuplicatedCode,LocalVariableNamingConventionJS
...
describe('c-event-bubbling', () => {
    ...
    describe('getContactList @wire data', () => {
        it('renders two c-contact-list-item-bubbling elements', async () => {
            ...
            // Emit data from @wire
            (<ApexTestWireAdapter><unknown>getContactList).emit(mockGetContactList);
        ...
        it('renders no c-contact-list-item-bubbling elements when no data', async () => {
            ...
            // Emit data from @wire
            (<ApexTestWireAdapter><unknown>getContactList).emit(mockGetContactListNoRecords);
    ...
    describe('getContactList @wire error', () => {
        it('shows error panel element', async () => {
            ...
            (<ApexTestWireAdapter><unknown>getContactList).error();
