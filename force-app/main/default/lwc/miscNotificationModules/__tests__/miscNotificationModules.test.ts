...
describe('c-misc-notification-modules', () => {
    ...
    it('shows an alert notification', async () => {
        ...
        // Click button
        const alertButton = element.shadowRoot.querySelector<LightningButton>(
    ...
    it('shows a confirm notification and text when ok', async () => {
        ...
        // Click button
        const confirmButton = element.shadowRoot.querySelector<LightningButton>(
    ...
    it('shows a prompt notification and entered text', async () => {
        ...
        // Click button
        const promptButton = element.shadowRoot.querySelector<LightningButton>(
