...
describe('c-apex-wire-method-with-complex-params', () => {
    ...
    describe('checkApexTypes @wire data', () => {
        it('gets called with a default configuration', async () => {
            ...
            expect((<ApexTestWireAdapter><unknown>checkApexTypes).getLastConfig()).toEqual({
        ...
        it('updates the wire parameter based on user input', async () => {
            ...
            const inputStringEl =
                element.shadowRoot.querySelector<LightningInput>('.string-input');
            ...
            const inputNumberEl =
                element.shadowRoot.querySelector<LightningInput>('.number-input');
        ...
        it('returns a string value based on user input values', async () => {
            ...
            // Emit data from @wire
            (<ApexTestWireAdapter><unknown>checkApexTypes).emit(mockCheckApexTypes);
    ...
    describe('checkApexTypes @wire error', () => {
        it('renders the error panel when the Apex method returns an error', async () => {
            ...
            (<ApexTestWireAdapter><unknown>checkApexTypes).error();
