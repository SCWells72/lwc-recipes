...
describe('c-light-dom-query', () => {
    ...
    it('changes inner text in the c-light-dom-query-child paragraph element', () => {
        ...
        const element = createElement<LightDomQuery>('c-light-dom-query', {
            is: LightDomQuery
        });
        ...
        const lightningButtonEls =
            element.shadowRoot.querySelectorAll<LightningButton>('lightning-button');
        ...
        const pEl = element.shadowRoot.querySelector<HTMLParagraphElement>('p.lightDomParagraph');
