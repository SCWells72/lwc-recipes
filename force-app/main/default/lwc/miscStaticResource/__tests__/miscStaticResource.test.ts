...
describe('c-misc-static-resource', () => {
    ...
    it('sets img urls based on static resources', () => {
        ...
        const imgTrailheadEl = element.shadowRoot.querySelector<HTMLImageElement>(
            'img[alt="Trailhead logo"]'
        );
        expect(imgTrailheadEl).not.toBeNull();
        // sfdx-lwc-jest auto-mocks @salesforce/resourceUsl, and returns localhost/name_of_resource.
        ...
        const imgEinsteinEl = element.shadowRoot.querySelector<HTMLImageElement>(
