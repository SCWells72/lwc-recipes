...
describe('c-misc-notification', () => {
    ...
    it('shows custom toast events based on user input', async () => {
        ...
        const inputTitleEl = element.shadowRoot.querySelector<LightningInput>(
        ...
        // Select input field for simulating user input
        const inputMessageEl = element.shadowRoot.querySelector<LightningInput>(
        ...
        const comboboxEl =
            element.shadowRoot.querySelector<LightningCombobox>('lightning-combobox');
