...
describe('c-lds-generate-record-input-for-create', () => {
    ...
    function generateMockRecordInput() {
        ...
        (<jest.MockInstance<any, any>><unknown>generateRecordInputForCreate).mockReturnValue(
            mockGenerateRecordInputForCreate
        );

        // Emit mock data from @wire
        (<LdsTestWireAdapter><unknown>getRecordCreateDefaults).emit(mockGetRecordCreateDefaults);
    }

    // Helper function to simulate user input on a field
    function simulateUserInput(element: Element, fieldName: string, value: string | number) {
        // Select input field for simulating user input
        const inputEl = element.shadowRoot.querySelector<LightningInput>(
    ...
    describe('getRecordCreateDefaults @wire data', () => {
        ...
        it('renders data correctly when field is not visible', async () => {
            ...
            delete (<Account>mockGenerateRecordInputForCreate).AreaNumber__c;
            generateMockRecordInput();
    ...
    describe('getRecordCreateDefaults @wire error', () => {
        it('shows error panel element', async () => {
            ...
            (<LdsTestWireAdapter><unknown>getRecordCreateDefaults).error();
    ...
    describe('createAccount', () => {
        it('populates recordInput correctly when inputs change', async () => {
            ...
            expect((<jest.MockInstance<any, any>><unknown>createRecord).mock.calls.length).toBe(1);
            ...
            expect((<jest.MockInstance<any, any>><unknown>createRecord).mock.calls[0][0]).toEqual(expectedRecordInput);
        });
