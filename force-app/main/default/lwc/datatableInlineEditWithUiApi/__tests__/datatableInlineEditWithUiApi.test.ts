...
describe('c-datatable-inline-edit-with-ui-api', () => {
    ...
    it('renders six rows in the lightning datatable', async () => {
        ...
        // Emit data from @wire
        (<ApexTestWireAdapter><unknown>getContacts).emit(mockGetContactList);
    ...
    it('updates the records on Save', async () => {
        ...
        expect((<jest.MockInstance<any, any>><unknown>updateRecord).mock.calls.length).toBe(2);

        // Validate the updateRecord function is called with right parameters
        expect((<jest.MockInstance<any, any>><unknown>updateRecord).mock.calls[0][0]).toEqual(INPUT_PARAMETERS);
    });
    ...
    it('displays an error toast on update record error', async () => {
        ...
        (<jest.MockInstance<any, any>><unknown>updateRecord).mockRejectedValue({
            body: {
    ...
    it('is accessible when error is returned', async () => {
        ...
        (<ApexTestWireAdapter><unknown>getContacts).error();
