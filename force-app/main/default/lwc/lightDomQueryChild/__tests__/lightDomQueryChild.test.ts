...
describe('c-light-dom-query-child', () => {
    ...
    it('changes inner text in the paragraph element', () => {
        ...
        const lightningButtonEl = element.querySelector<LightningButton>('lightning-button');
        ...
        const pEl = element.querySelector<HTMLParagraphElement>('p.lightDomParagraph');
